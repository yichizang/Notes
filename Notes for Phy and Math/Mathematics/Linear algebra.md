...
### 1.1 Vector space
#### 1.1.1 Definition
A *vector space* is a set $V$ equipped with an *addition* $+:V\times V\to V$ and a *scalar multiplication* $\cdot:\mathbb{F}\times V\to V$ on a field $\mathbb{F}$. It's an [[Group theory#1.1.4 Abelian group|Abelian]] [[Group theory#1.1.2 Group|group]] under addition operation. It also satisfies that $\forall \lambda,\xi\in\mathbb{F},\forall\ket{u},\ket{v}\in V$
...
#### 1.1.2 Subspace and sum of subspace
...
#### 1.1.4 Linear dependence and basis
...
This is called the *matrix of linear map* $T$ under this basis, sometimes denoted as $\mathcal{M}(T)$. Here the matrix is $\dim W\times\dim V$.
...
---
### 1.4 Product and quotient
#### 1.4.1 Product of vector space
...
#### 1.5.4 Kernal and image of dual map
